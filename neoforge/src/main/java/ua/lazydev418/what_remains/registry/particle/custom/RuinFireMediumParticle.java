...
public class RuinFireMediumParticle extends SingleQuadParticle {
    private final float startSize;
    private final float maxSize;

    private final Layer layer;

    protected RuinFireMediumParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet) {
        ...
        this.xd = (random.nextFloat() - 0.5F) * 0.015;
        this.zd = (random.nextFloat() - 0.5F) * 0.015;
        this.yd = 0.0;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5, RandomSource randomSource) {
            ...
            return new RuinFireMediumParticle(clientLevel, v, v1, v2, this.sprites);
        }
    }
}